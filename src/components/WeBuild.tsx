	...
	return (
		<Background>
			<section className="we_build" ref={rootRef}>
				<Image className="we_build-dna we_build-dna--desktop" src="/dna.png" alt="DNA double helix" width={1920} height={1373} sizes="112vw" />
				<Image className="we_build-dna we_build-dna--mobile" src="/dna_mob-new.png" alt="" width={430} height={932} sizes="100vw" aria-hidden="true" />
