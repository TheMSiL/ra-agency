...
export const siteSettings = defineType({
	...
	fields: [
		...
		defineField({ name: "linkedinLabel", title: "LinkedIn label", type: "string", initialValue: "RA Agency" }),
		defineField({ name: "linkedinUrl", title: "LinkedIn URL", type: "url", initialValue: "https://www.linkedin.com/company/ra-agency-tech/" }),
