...
const en = {
	...
	'form.name': 'Name',
	'form.nameInvalid': 'Please enter at least 2 characters',
	...
	'form.detailsInvalid': 'Please tell us a little more — at least 10 characters',
	...
	'notFound.text': 'The page you are looking for has been moved, renamed or never existed. The links below will get you back on track.',
	'notFound.home': 'Back to home',
	'notFound.cases': 'Browse our cases',
	'error.title': 'Something went wrong',
	'error.text': 'This page failed to load. It is usually temporary — try again, and if it keeps happening please get in touch.',
...
export const dictionaries: Record<Locale, Record<TranslationKey, string>> = {
	...
	ru: {
		...
		'notFound.text': 'Страница была перемещена, переименована или никогда не существовала. Ссылки ниже вернут вас на нужный путь.',
		'notFound.home': 'На главную',
		'notFound.cases': 'Смотреть кейсы',
		'error.title': 'Что-то пошло не так',
		'error.text': 'Страница не загрузилась. Обычно это временно — попробуйте ещё раз, а если повторится, напишите нам.',
		...
		'common.message': 'Оставить заявку',
		'common.toTop': 'Наверх',
		...
		'form.name': 'Имя',
		'form.nameInvalid': 'Введите минимум 2 символа',
		...
		'form.detailsInvalid': 'Расскажите немного подробнее — минимум 10 символов',
		'form.submit': 'Начать',
	...
	ua: {
		...
		'notFound.text': 'Сторінку переміщено, перейменовано або вона ніколи не існувала. Посилання нижче повернуть вас на потрібний шлях.',
		'notFound.home': 'На головну',
		'notFound.cases': 'Дивитися кейси',
		'error.title': 'Щось пішло не так',
		'error.text': 'Сторінка не завантажилася. Зазвичай це тимчасово — спробуйте ще раз, а якщо повториться, напишіть нам.',
		...
		'common.message': 'Залишити заявку',
		'common.toTop': 'Догори',
		...
		'form.name': 'Ім’я',
		'form.nameInvalid': 'Введіть щонайменше 2 символи',
		...
		'form.details': 'Деталі',
		'form.detailsInvalid': 'Розкажіть трохи детальніше — щонайменше 10 символів',
